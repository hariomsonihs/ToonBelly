...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.ViewHolder> {
    ...
    private OnHistoryVideoListener listener;
    private Context context;

    public interface OnHistoryVideoListener {
        void onVideoClick(Video video);
        void onRemove(Video video);
    }

    public HistoryAdapter(List<Video> videos, OnHistoryVideoListener listener) {
        this.videos = videos;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btnRemove.setOnClickListener(v -> listener.onRemove(video));
    }
